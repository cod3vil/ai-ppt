    ...
    <div className={className}>
      ...
      >
        <PopoverTrigger asChild>
          <button
            type="button"
            className="h-8 w-10 shrink-0 cursor-pointer rounded-full border border-[var(--color-border-default)]/70 p-1"
        ...
        <PopoverContent
          className="color-picker-popover w-[208px] rounded-lg border border-[var(--color-border-default)]/60 bg-[#ffffff] p-3 shadow-[0_8px_30px_-6px_rgba(74,59,42,0.18)]"
          align="start"
          sideOffset={8}
        >
          ...
          <div className="mt-3 flex items-center gap-2">
            ...
            <div className="relative flex-1">
              ...
              <HexColorInput
                ...
                className="color-picker-input h-7 w-full rounded-lg border border-[var(--color-border-default)]/60 bg-[#faf6ee] pl-4 pr-2 text-[11px] tracking-wide text-[var(--color-fg-default)] outline-none transition-colors focus:border-[var(--color-brand-hover)]"
              />
            </div>
            {/* alpha input */}
            <div className="flex items-center gap-1">
              <input
                ...
                className="color-picker-input h-7 w-[42px] rounded-lg border border-[var(--color-border-default)]/60 bg-[#faf6ee] px-1.5 text-right text-[11px] text-[var(--color-fg-default)] outline-none transition-colors focus:border-[var(--color-brand-hover)]"
              />
